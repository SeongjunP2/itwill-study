...
public class BlogCreateFrame extends JFrame {
	...
	public void initialize() {
		...
		lblTitle.setBounds(12, 10, 410, 46);
		contentPane.add(lblTitle);
		
		textTitle = new JTextField();
		textTitle.setFont(new Font("굴림", Font.PLAIN, 15));
		textTitle.setBounds(12, 57, 410, 46);
		contentPane.add(textTitle);
		textTitle.setColumns(10);
		
		lblContent = new JLabel("내용");
		lblContent.setFont(new Font("굴림", Font.BOLD, 20));
		lblContent.setBounds(12, 103, 410, 46);
		contentPane.add(lblContent);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(12, 159, 410, 232);
		...
		btnSave.setBounds(12, 497, 193, 49);
		...
		btnCancel.setBounds(229, 497, 193, 49);
	...
	private void createNewBlog() {
		...
		String writer = textContent.getText();
