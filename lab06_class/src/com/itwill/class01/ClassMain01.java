...
public class ClassMain01 {
	...
	public static void main(String[] args) {
		String s1 = "안녕하세요!";
		System.out.println("s1 length: " + s1.length()); // length(): 문자열 객체의 기능(매서드)(배열에 사용된 length는 속성)
		System.out.println("s1 concat: " + s1.concat("비가 오네요...")); // concat 문자열을 이어붙여주는 기능
