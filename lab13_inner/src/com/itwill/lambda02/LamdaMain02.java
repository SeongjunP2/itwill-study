...
public class LamdaMain02 {
	...
	public static void main(String[] args) {
		LamdaMain02 app = new LamdaMain02(); // filter 메서드를 호출하기 위해서
		...
		List<Object> Languages = Arrays.asList("JAVA", "Sql", "HTML", "JavaScript", "Pyton");
...
//		});
		...
		List<Object> upperCase = app.map(Languages, (x) -> ((String)x).toUpperCase());
