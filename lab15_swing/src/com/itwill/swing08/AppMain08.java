...
public class AppMain08 {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 556, 538);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		lblKorean = new JLabel("국어");
		lblKorean.setFont(new Font("굴림", Font.BOLD, 20));
		lblKorean.setBounds(12, 10, 97, 52);
		frame.getContentPane().add(lblKorean);
		
		textKorean = new JTextField();
		textKorean.setFont(new Font("굴림", Font.PLAIN, 15));
		textKorean.setBounds(107, 10, 421, 52);
		frame.getContentPane().add(textKorean);
		textKorean.setColumns(10);
		
		textEnglish = new JTextField();
		textEnglish.setFont(new Font("굴림", Font.PLAIN, 15));
		textEnglish.setColumns(10);
		textEnglish.setBounds(107, 72, 421, 52);
		frame.getContentPane().add(textEnglish);
		
		lblEnglish = new JLabel("영어");
		lblEnglish.setFont(new Font("굴림", Font.BOLD, 20));
		lblEnglish.setBounds(12, 72, 97, 52);
		frame.getContentPane().add(lblEnglish);
		
		textMath = new JTextField();
		textMath.setFont(new Font("굴림", Font.PLAIN, 15));
		textMath.setColumns(10);
		textMath.setBounds(107, 134, 421, 52);
		frame.getContentPane().add(textMath);
		
		lblMath = new JLabel("수학");
		lblMath.setFont(new Font("굴림", Font.BOLD, 20));
		lblMath.setBounds(12, 134, 97, 52);
		...
		btnEnter.setFont(new Font("굴림", Font.BOLD, 20));
		btnEnter.setBounds(12, 196, 247, 52);
		frame.getContentPane().add(btnEnter);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(12, 263, 516, 226);
		...
		btnDelete.setBounds(281, 196, 247, 52);
